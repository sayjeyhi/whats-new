  ...
  return (
    <header className="text-center pt-6 relative">
      ...
      {isHome ? (
        <a href="/" className="mb-10">
          ...
          <div className="mb-5 flex items-center justify-center flex-col gap-4">
            ...
            <p className="text-base text-gray-600 w-4/5 dark:text-gray-400">
              Stay ahead with the latest features and updates for each language
              and technology – all in one place, no Googling required!
            </p>
          </div>
        </a>
      ) : (
        <a
          href="/"
          className="absolute group top-5 left-0 flex items-center gap-4"
        >
          <img
